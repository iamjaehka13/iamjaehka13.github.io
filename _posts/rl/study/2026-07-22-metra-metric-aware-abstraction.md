...
<div class="row g-3 my-3">
  <div class="col-md-6">
    ...
    <video autoplay loop muted playsinline controls preload="metadata" poster="/assets/img/posts/rl/metra/13-quadruped-lsd-poster.jpg" style="width: 100%; border-radius: 6px;">
      <source src="/assets/img/posts/rl/metra/13-quadruped-lsd.mp4" type="video/mp4">
    </video>
  </div>
  <div class="col-md-6">
    <p class="fw-semibold mb-2">METRA: temporal metric</p>
    <video autoplay loop muted playsinline controls preload="metadata" poster="/assets/img/posts/rl/metra/12-quadruped-metra-poster.jpg" style="width: 100%; border-radius: 6px;">
      <source src="/assets/img/posts/rl/metra/12-quadruped-metra.mp4" type="video/mp4">
    </video>
  </div>
</div>
...
<figure class="my-3">
  <video autoplay loop muted playsinline controls preload="metadata" poster="/assets/img/posts/rl/metra/14-humanoid-metra-poster.jpg" style="width: 100%; border-radius: 6px;">
    <source src="/assets/img/posts/rl/metra/14-humanoid-metra.mp4" type="video/mp4">
  </video>
