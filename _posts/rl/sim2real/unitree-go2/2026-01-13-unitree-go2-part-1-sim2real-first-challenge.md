...
date: 2026-01-30 14:28:00 +0900
last_modified_at: 2026-01-30 14:28:00 +0900
...
- Go2에 `/lowcmd`를 전달하려면, 기존에 내부에서 동작하던 control system을 먼저 shutdown해야 했다.
  - 이를 위해 `unitree_sdk2_python`의 `msc` interface를 사용해 RL mode로 전환했다.
        ...
        [![](https://media.iamjaehka13.blog/assets/img/posts/unitree/sim2real/unitree-go2-part-1-sim2real-first-challenge/321cbb7d-7937-80c7-bb29-c37f639f4d00.gif)](https://media.iamjaehka13.blog/assets/img/posts/unitree/sim2real/unitree-go2-part-1-sim2real-first-challenge/321cbb7d-7937-80c7-bb29-c37f639f4d00.gif){.popup .img-link .shimmer}
